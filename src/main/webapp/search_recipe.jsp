...
<script type="text/javascript">
    ...
    xmlhttp.onreadystatechange = function() {
                ...
                for (i = 0; i < arr.length; i++) {
                    ...
                    if (temp_ingredients.includes(keyword) == true || temp_name.includes(keyword)) {
                        ...
                        out += "<div class=\"col-xs-12 col-md-6\">\n" +
                            ...
                            "\n" +
                            "                   <h5 class='name'><a href='./home?action=show_recipe&&selected_recipe=" +
                            arr[i]._id['$oid'] + "&&search_keyword=" + keyword + "'>" + arr[i].name + "</a></h5> " +
                            "                   <a class='btn btn-info' href='/home?action=favourite&&search_keyword="+keyword+"&&recipe_id=" + arr[i]._id['$oid']+ "'>Like!</a>" +
                            "               </div>\n" +
        ...
        document.getElementById("demo").innerHTML = "<center><h4 style='color: #21c2f8;font-family: Lato, sans-serif;'>Showing "+count+" Results</h4></center>"+out;
    };
